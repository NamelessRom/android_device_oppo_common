    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (ACTION_CONTROL.equals(action)) {
            ...
            if (!hasSlider()) {
                ...
                int keyCode_slider_top = Constants.getPreferenceInteger(context, "keycode_slider_top", 600);
                int keyCode_slider_middle = Constants.getPreferenceInteger(context, "keycode_slider_middle", 601);
                int keyCode_slider_bottom = Constants.getPreferenceInteger(context, "keycode_slider_bottom", 602);

                FileUtils.writeLine(Constants.KEYCODE_SLIDER_TOP, String.valueOf(keyCode_slider_top));
                FileUtils.writeLine(Constants.KEYCODE_SLIDER_MIDDLE, String.valueOf(keyCode_slider_middle));
                FileUtils.writeLine(Constants.KEYCODE_SLIDER_BOTTOM, String.valueOf(keyCode_slider_bottom));
            }
